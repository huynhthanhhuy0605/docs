...
{/* DRAFT (hidden:true → renders but not in nav, noindex). Target product: Frames Lab (Tier 1). Facts: qrdy-hub/canva-apps/frames-lab. When approved: remove `hidden: true` and add to docs.json nav. */}
